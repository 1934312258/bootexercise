...
public class BitFieldSubCommands implements Iterable<BitFieldSubCommands.BitFieldSubCommand> {
    private final List<BitFieldSubCommands.BitFieldSubCommand> subCommands;
    ...
    public Iterator<BitFieldSubCommands.BitFieldSubCommand> iterator() {
    ...
    public static class BitFieldType {
        // signed true代表有符号数，false无符号数，有符号数指二进制补码的最高位代表正负，0为正数、1为负数
